...
let JwtMetadata = JwtMetadata_1 = class JwtMetadata {
    constructor(_meta) {
        this._meta = _meta;
    }
    get originalMeta() {
...
JwtMetadata = JwtMetadata_1 = __decorate([
    injectable_decorator_1.Injectable({
        provide: {
            useCallback: function (meta) {
                let jwtMeta = meta.originalMeta.jwt;
                return !!jwtMeta ? new JwtMetadata_1(jwtMeta) : null;
            },
            deps: [server_1.ServerMetadata],
            cache: true
        }
    }),
    __metadata("design:paramtypes", [Object])
], JwtMetadata);
exports.JwtMetadata = JwtMetadata;
var JwtMetadata_1;
