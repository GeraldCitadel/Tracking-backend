...
let JwtPolicy = class JwtPolicy extends jwt_base_policy_1.JwtBasePolicy {
    constructor(jwtMeta, core) {
        super(jwtMeta, core, false);
    }
};
JwtPolicy = __decorate([
    policy_decorator_1.Policy(),
    __metadata("design:paramtypes", [jwt_1.JwtMetadata, logger_core_1.LoggerCore])
], JwtPolicy);
exports.JwtPolicy = JwtPolicy;
//# sourceMappingURL=jwt.policy.js.map