...
const stub_direct_logger_1 = require("../../util/test/stub-direct-logger");
...
describe('LoggerCore', () => {
    let instance;
    before(() => instance = new logger_core_1.LoggerCore(testServerName, logLevels, false));
    let stubs = stub_direct_logger_1.stubDirectLogger();
    describe('.serverName', () => {
        it('should persist the server name correctly', () => {
            chai_1.expect(instance.serverName).to.eq(testServerName);
        });
    });
    describe('.getSubsystem', () => {
        it('should return an instance of Logger with the specified subsystem', () => {
            ...
            chai_1.expect(logger).to.be.an.instanceOf(logger_1.Logger);
            chai_1.expect(logger.subsystem).to.eq('fish');
        });
        it('should only create one logger for each subsystem', () => {
            ...
            chai_1.expect(logger1).to.eq(logger2);
        });
    });
    describe('.log', () => {
        it('should call console.log with the server, subsystem, and message', () => {
            ...
            chai_1.expect(log).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'message1', 'message2', 'message3');
        });
        it('should call console.log with the server and message if there is no subsystem', () => {
            ...
            chai_1.expect(log).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'message1', 'message2', 'message3');
        });
    });
    describe('.trace', () => {
        it('should call console.trace with the server, subsystem, and message', () => {
            ...
            chai_1.expect(trace).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'message1', 'message2', 'message3');
        });
        it('should call console.trace with the server and message if there is no subsystem', () => {
            ...
            chai_1.expect(trace).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'message1', 'message2', 'message3');
        });
    });
    describe('.error', () => {
        it('should call console.error with the server, subsystem, and message', () => {
            ...
            chai_1.expect(error).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'error:', 'message1', 'message2', 'message3');
        });
        it('should call console.error with the server and message if there is no subsystem', () => {
            ...
            chai_1.expect(error).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'error:', 'message1', 'message2', 'message3');
        });
    });
    describe('.info', () => {
        it('should call console.info with the server, subsystem, and message', () => {
            ...
            chai_1.expect(info).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'info:', 'message1', 'message2', 'message3');
        });
        it('should call console.info with the server and message if there is no subsystem', () => {
            ...
            chai_1.expect(info).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'info:', 'message1', 'message2', 'message3');
        });
        it('should call console.info if the subsystem is info or verbose', () => {
            ...
            chai_1.expect(info).to.have.been.called;
        });
        it('should not call console.info if the subsystem is error or warn', () => {
            ...
            chai_1.expect(info).not.to.have.been.called;
        });
    });
    describe('.warn', () => {
        it('should call console.warn with the server, subsystem, and message', () => {
            ...
            chai_1.expect(warn).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'warn:', 'message1', 'message2', 'message3');
        });
        it('should call console.warn with the server and message if there is no subsystem', () => {
            ...
            chai_1.expect(warn).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'warn:', 'message1', 'message2', 'message3');
        });
    ...
    describe('.verbose', () => {
        it('should call console.log with the server, subsystem, and message', () => {
            ...
            chai_1.expect(log).to.have.been.calledWithMatch(/\[.*abc-xyz.*:.*subsys.*\]/, 'verbose:', 'message1', 'message2', 'message3');
        });
        it('should call console.log with the server and message if there is no subsystem', () => {
            let { log } = stubs;
            instance.verbose(null, 'message1', 'message2', 'message3');
            chai_1.expect(log).to.have.been.calledWithMatch(/\[.*abc-xyz[^:]*\]/, 'verbose:', 'message1', 'message2', 'message3');
        });
        it('should call console.log if the subsystem is verbose', () => {
            let { log } = stubs;
            instance.verbose('verbose', 'message1', 'message2', 'message3');
            chai_1.expect(log).to.have.been.called;
        });
        it('should not call console.log if the subsystem is error, warn, or info', () => {
            ...
            chai_1.expect(log).not.to.have.been.called;
        });
    });
});
//# sourceMappingURL=logger-core.spec.js.map